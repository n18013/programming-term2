...
class Player:
    ...
    def battle(self, enemy):
        ...
        #このbattle()メソッド内の以降の処理をここに書くとメソッドが長くなるので、以下に定義したget_exp()メソッド内に移動してください。
        #移動したら、self.get_exp()を呼び出してください。
    ...
    def get_exp(self):
        ...
        なし
        """
        #battle()メソッドの最後にあった経験値取得処理をここに貼り付けてください。
        # 経験値を1獲得
        self.exp += 1
        print("経験値を1獲得した!")
