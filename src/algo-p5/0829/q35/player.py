...
class Player:
    ...
    #battle_vs_bossを定義します。引数はselfのみです。
    def battle_vs_boss(self):
        ...
        なし
        """
        #"さちさち"という名前のBossCharaクラスのオブジェクトを生成し、変数bossに代入してください。
        boss = BossChara("さちさち")


        #self.battle()の引数にbossを渡して呼び出してください。
        self.battle(boss)
...
if __name__ == '__main__':
    ...
    #ケビンがボスと戦います。kevin.battle_vs_boss()を呼び出してください。(引数を渡す必要はありません)
